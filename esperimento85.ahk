...
BuildRow:
    ...
    if (varconfronto <> "") {
        ...
        ; msgbox ciao %currentItMarker% - %textItOrig%
        if (hasItMarker) {
         ;msgbox ciao1
            ...
            ; Valorizza aggiungii con InStr per ogni marcatore
           ...
           ;     msgbox  aggiungi = 1
            ...
            ; Applica la correzione solo se il marcatore è cambiato o se dobbiamo aggiungere la "i"
